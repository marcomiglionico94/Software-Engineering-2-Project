...
R.10.2 & The system must be able to recognize the best power grid to station where to park a specified car based on its position and the distribution of the other cars of PowerEnJoy. & CMP: Fee Manager, ALG: 4 & The function Position safeAreaCenter enableMoneySavingOption() does it. \\ \hline
